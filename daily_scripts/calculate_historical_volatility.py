...
def store_hv_in_db(db_path, ticker, hv_dict):
    ...
    for date, values in hv_dict.items():
        cursor.execute("""
            ...
            (ticker, fetch_date, hv_10, hv_20, hv_30, hv_60)
            VALUES (?, ?, ?, ?, ?, ?)
...
##        # Debugging: Print HV values to check if they are being calculated
##        print(f"📊 {ticker} HV Data:")
##        for date, values in hv_dict.items():
##            print(f"Date: {date}, HV 10: {values['hv_10']}, HV 20: {values['hv_20']}, HV 30: {values['hv_30']}, HV 60: {values['hv_60']}")
...
if __name__ == '__main__':
    ...
    "SOFI", "MARA", "SMCI", "BABA", "COIN"]  # Replace with your list of tickers
